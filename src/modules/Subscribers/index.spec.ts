...
describe('List', () => {
  ...
  describe('list', () => {
    it('should be able to list all subscribers of a list', async () => {
      console.info('getting subscribers for list', 'vl868om97q58a');

      const result = await subscribers.all('vl868om97q58a');

      console.info('list all subscribers result:', result);
      console.info('subscribers:', result.data?.records);
